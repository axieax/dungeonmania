...
public final class FileLoader {
    ...
    public static String loadResourceFile(String path) throws IOException {
        ...
        try {
            return new String(
                Files.readAllBytes(Path.of(FileLoader.class.getResource(path).toURI()))
            );
     ...
     * @throws IOException If directory path is invalid or some other sort of IO issue occurred.
     */
    public static List<String> listFileNamesInDirectoryOutsideOfResources(String directory)
        throws IOException {
